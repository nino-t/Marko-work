$_mod.def("/marko$4.12.2/src/components/renderer", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.12.2/src/components/util-browser'/*"./util"*/);
var componentLookup = componentsUtil.___componentLookup;
var emitLifecycleEvent = componentsUtil.___emitLifecycleEvent;

var ComponentsContext = require('/marko$4.12.2/src/components/ComponentsContext'/*"./ComponentsContext"*/);
var getComponentsContext = ComponentsContext.___getComponentsContext;
var registry = require('/marko$4.12.2/src/components/registry-browser'/*"./registry"*/);
var copyProps = require('/raptor-util$3.2.0/copyProps'/*"raptor-util/copyProps"*/);
var isServer = componentsUtil.___isServer === true;
var beginComponent = require('/marko$4.12.2/src/components/beginComponent-browser'/*"./beginComponent"*/);
var endComponent = require('/marko$4.12.2/src/components/endComponent-browser'/*"./endComponent"*/);
